...
const renderTabBar = (props: React.JSX.IntrinsicAttributes) => (
  <TabBar
    ...
    renderLabel={({route, focused}) => (
      <Text
        style={{
          color: focused ? colors.appBackgroundColor : 'black',
          fontSize: 15,
          fontWeight: 800,
        }}>
        {route.title}
      </Text> // Change color for active tab
    )}
  />
);
...
const PlaceDetails = () => {
        ...
        for (const content of area.AreaContents) {
          for (const file of content.ContentFiles) {
            ...
            if (!fileExists) {
              ...
              Alert.alert(
                'File Exists',
                `The File ${file.Link} already exists`,
                [
                  {
                    text: 'Ok',
  ...
  // const file =
  //   'http://portal.audiwalk.com/Uploads/98f106afd00e4856ad071dd8c191082d.mp3';
  // var audio = new Sound(file, null, error => {
  //   if (error) {
...
//   }
// }
// const [route] = React.useState([
//   { key: 'first', title: apiData[0].Areas[0].AreaContents[0].ContentFiles[0].Name},
//   { key: 'second', title: apiData[0].Areas[0].AreaContents[0].ContentFiles[1].Name},
//   {key:'third',title:apiData[0].Areas[0].AreaContent[0].ContentFiles[2].Name}
// ]);
const playAudio=()=>{
  const audioLink=apiData[0].Areas[0].AreaContents[0].ContentFiles
  console.log('audiolinkfile',audioLink);
  console.log('apiData',apiData);
  
  navigation.navigate('StartTour',{data:apiData[0].Areas[0].AreaContents[0].ContentFiles,placeName:apiData[0].Areas[0].AreaContents[0].Title,apiData:apiData});
  console.log('came');
  ...
  return (
    <SafeAreaView
      ...
      style={{
        flex: 1,
        backgroundColor: showLoading ? colors.appBackgroundColor : colors.white,
      }}>
      {showLoading && <LottieLoading text="Downloading your content...." />}
      {!showLoading && (
        <View
          style={{flex: 1.2, backgroundColor: '#fff', alignItems: 'center'}}>
          <StatusBar
          ...
          <Image
            ...
            source={{uri: filePath + apiData[0]?.Features[0]?.Link}}
          />
          {/* {homescreen image} */}
          ...
          <Modal
            ...
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                ...
                <Text style={{fontSize: 22, fontWeight: 700, marginTop: 25}}>
                  Do you want to sync content now ?
                </Text>
                  ...
                  <View style={{backgroundColor: '#fff', height: '100%'}}>
                    <View style={{paddingVertical: 25, paddingHorizontal: 20}}>
                      ...
                      <View
                        ...
                        <Text
                          style={{fontSize: 14, lineHeight: 20, color: 'grey'}}>
                  ...
                  <View style={{backgroundColor: '#fff', height: '100%'}}>
                    ...
                    <View>
                      <View style={{paddingVertical: 0, paddingHorizontal: 20}}>
                        <Text
                          style={{fontSize: 17, fontWeight: 400, color: 'red'}}>
                          Places
                        </Text>
